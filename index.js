...
async function viewAllEmployeesByDepartment() {
    ...
    console.log("");
    let query = "SELECT first_name, last_name, department.name FROM ((employee INNER JOIN role ON role_title = role.id) INNER JOIN department ON department_id = department.name);";
    const rows = await db.query(query);
    console.table(rows);
}
